...
phpbb_search=$(find $search_path -maxdepth 7 -iwholename "*prosilver/style.cfg")
magento_search=$(find $search_path -maxdepth 7 -iwholename "*/app/Mage.php")
opencart_search=$(find $search_path -maxdepth 7 -iwholename "*/upload/index.php")
moodle_search=$(find $(find $search_path -maxdepth 7 -type f -name "TRADEMARK.txt" | sed 's/TRADEMARK.txt//') -maxdepth 1 -name "version.php" -print)
